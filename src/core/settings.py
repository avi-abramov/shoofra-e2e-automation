...
class Settings:
    ...
    slow_mo_ms: int = field(default_factory=lambda: _get_int("SLOW_MO_MS", 180))
    ...
    test_pause_ms: int = field(default_factory=lambda: _get_int("TEST_PAUSE_MS", 250))
    ...
    demo_action_pause_ms: int = field(default_factory=lambda: _get_int("DEMO_ACTION_PAUSE_MS", 220))
